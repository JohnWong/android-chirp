...
public class NativeAudio extends Activity {
    ...
    static final int CLIP_1760 = 5;
    static final int CLIP_1864 = 6;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        ((Button) findViewById(R.id.clip1760)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                // ignore the return value
                selectClip(CLIP_1760, 8);
            }
        });
        
        ((Button) findViewById(R.id.clip1864)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                // ignore the return value
                selectClip(CLIP_1864, 16);
            }
        });
